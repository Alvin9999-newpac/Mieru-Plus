...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Alvin9999-newpac/Mieru-Plus/main/mieru-plus.sh)
```

或者下载后运行：

```bash
curl -O https://raw.githubusercontent.com/Alvin9999-newpac/Mieru-Plus/main/mieru-plus.sh
bash mieru-plus.sh
```
